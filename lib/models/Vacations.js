...
module.exports = class Vacations {
    ...
    static async insert({ destination, startDate, endDate, details, photo }) {
        const { rows } = await pool.query(
            'INSERT INTO vacations (destination, start_date, end_date, details, photo) VALUES ($1, $2, $3, $4, $5) RETURNING *', [destination, startDate, endDate, details, photo]
        );
